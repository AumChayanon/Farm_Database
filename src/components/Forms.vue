<template>
  <div class="div_forms">
    <div>
      ...
      <br />
      <div class="cardForms" v-if="this.statusMap === 'default'">
        <div class="container" style="width: 100%; padding-top: 0px;">
          <!-- card ที่อยู่ -->
          <div class="card">
            <p>รหัสองค์กรเก็บข้อมูล: {{ this.user }}</p>
              ...
              <div v-for="(family, counter) in data.families" v-bind:key="counter">
                ...
                <b-form-group label="(สามารถเลือกได้มากกว่า 1):">
                  ...
                  <b-form-checkbox-group
                    ...
                    :disabled="family.disease.sta_dis[0] === 'ไม่มี'"
                    :id="'checkbox' + counter"
                  ...
                  <input
                    v-if="
                        family.disease.sta_dis[10] === 'อื่นๆ'
                      "
                    class="form-control"
                    type="text"
                ...
                <div class="form-group">
                  ...
                  <b-form-group>
                    ...
                    <div
                      class="row"
                      v-if="
                          family.re_farm_job.animal.status[0] === 'เลี้ยงสัตว์'
                        "
                    >
                      <div class="col">
                  ...
                  <b-form-group>
                    ...
                    <div
                      class="row"
                      v-if="
                          family.re_farm_job.vegetables.status[0] === 'ปลูกผัก'
                        "
                    >
                      <div class="col">
                  ...
                  <b-form-group>
                    ...
                    <div
                      class="row"
                      v-if="
                          family.re_farm_job.pre_animal.status[0] ===
                            'เลี้ยงสัตว์'
                        "
                    >
                      <div class="col">
                  ...
                  <b-form-group>
                    ...
                    <div
                      class="row"
                      v-if="
                          family.re_farm_job.pre_mat.status[0] === 'ทอเสื่อ'
                        "
                    >
                      <div class="col">
                        <label for="exampleFormControlSelect1">ทอเสื่อ</label>
                  ...
                  <b-form-group>
                    ...
                    <div
                      class="row"
                      v-if="
                          family.re_farm_job.pre_vegetables.status[0] ===
                            'ปลูกผัก'
                        "
                    >
                      <div class="col">
                        ...
                        <input
                          ...
                          placeholder="เฉลี่ย (บาท/เดือน)"
                          v-model="
                              family.re_farm_job.pre_vegetables.vegetables
                            "
                        />
                      </div>
                    </div>
                  ...
                  <b-form-group>
                    ...
                    <div
                      class="row"
                      v-if="
                          family.re_farm_job.pre_other.status[0] === 'อื่นๆ'
                        "
                    >
                      <div class="col">
                        <input
                  ...
                  <b-form-group>
                    ...
                    <div
                      class="row"
                      v-if="
                          family.ex_farm_job.fertilizer.status[0] === 'ค่าปุ๋ย'
                        "
                    >
                      <div class="col">
                  ...
                  <b-form-group>
                    ...
                    <div
                      class="row"
                      v-if="
                          family.ex_farm_job.rice.status[0] ===
                            'ค่าเมล็ดพันธุ์ข้าว'
                        "
                    >
                      <div class="col">
                  ...
                  <b-form-group>
                    ...
                    <div
                      class="row"
                      v-if="
                          family.ex_farm_job.animal_feed.status[0] ===
                            'ค่าอาหารสัตว์'
                        "
                    >
                      <div class="col">
                  ...
                  <b-form-group>
                    ...
                    <div
                      class="row"
                      v-if="
                          family.ex_farm_job.pre_fertilizer.status[0] ===
                            'ค่าปุ๋ย'
                        "
                    >
                      <div class="col">
                        ...
                        <input
                          ...
                          placeholder="เฉลี่ย (บาท/ปี)"
                          v-model="
                              family.ex_farm_job.pre_fertilizer.fertilizer
                            "
                        />
                      </div>
                    </div>
                  ...
                  <b-form-group>
                    ...
                    <div
                      class="row"
                      v-if="
                          family.ex_farm_job.pre_wage.status[0] === 'ค่าจ้าง'
                        "
                    >
                      <div class="col">
                        <label for="exampleFormControlSelect1">ค่าจ้าง</label>
                    ...
                    >
                      <div class="col">
                        ...
                        <input
                          ...
                          placeholder="เฉลี่ย (บาท/เดือน)"
                          v-model="
                              family.ex_farm_job.pre_animal_feed.animal_feed
                            "
                        />
                      </div>
                    </div>
                  ...
                  <b-form-group>
                    ...
                    <div
                      class="row"
                      v-if="
                          family.ex_farm_job.pre_other.status[0] === 'อื่นๆ'
                        "
                    >
                      <div class="col">
                        <input
          ...
          <div class="card">
            ...
            <div v-for="(area, counter) in data.land" v-bind:key="counter">
              <span v-on:click="deleteland(counter)" style="float: right;">X</span>
              <br />
              ...
              <div class="row">
                <div class="col">
                  ...
                  <p style="color:#508944; font-size:16px;">{{area.location}}</p>
                </div>
              </div>
              <div class="form-group">
                <button
                  ...
                  style="color: #ffffff;"
                  class="btnMap"
                  v-on:click="showMap(counter)"
                >Map</button>
              </div>
              <hr />
            </div>
            <button v-on:click="addland" class="btn_add">+ เพิ่มแปลง</button>
          </div>

          <div class="saveData">
            <button type="button" class="btnSave" v-on:click="saveData">บันทึก</button>
          </div>
        </div>
      </div>
      ...
      <!-- save -->
      <div
        v-else-if="this.statusMap === 'save'"
        style="padding: 25px; background-color: #ffffff; border-radius:25px 25px 0px 0px ; box-shadow: 0px -10px #88888838;"
        id="slide3"
      >
        <button
          type="button"
        ...
        <h1>ยืนยันตัวตน</h1>
        <div class="form-group">
          <label for="exampleFormControlSelect1">ชื่อผู้กรอกข้อมูล</label>
          <input
            class="form-control"
            type="text"
            placeholder="ชื่อผู้กรอก"
            v-model="data.explorers.name"
          />
        </div>
        <div class="form-group">
          <label for="exampleFormControlSelect1">วัน/เดือน/ปี</label>
          <input
            class="form-control"
            type="text"
            placeholder="วัน/เดือน/ปี"
            v-model="data.explorers.date"
          />
        </div>
        <div class="form-group">
          <label for="exampleFormControlSelect1">เวลา</label>
          <input class="form-control" type="text" placeholder="เวลา" v-model="data.explorers.time" />
        </div>
        <div class="saveData">
          <button type="button" class="btnSave" v-on:click="sendData">ส่ง</button>
        </div>
      </div>
      <!-- Google Map -->
      <div v-if="this.statusMap === 'map'" class="cardForms">
        <div>
          <div>
            <button
              type="button"
            ...
            <button type="button" style="color: #ff4a4a;" class="btnGMap" v-on:click="outMap">ออก</button>
...
browserGeolocationSuccess(position) {
  ...
  switch (error.code) {
    ...
    saveData() {
      ...
      this.statusMap = "save";
      this.data.explorers.date =
        today.getDate() +
        "/" +
        (today.getMonth() + 1) +
        "/" +
        today.getFullYear();
      this.data.explorers.time =
...
.btn_add {
  width: 100%;
  height: 30px;
  background-color: #4f894400;
  color: #508944;
  border: 1px solid #508944;
  border-radius: 5px;
  text-align: center;
  font-size: 16px;
  margin: auto;
