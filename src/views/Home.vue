<template>
  <div class="bodyHome">
    <!--div
      class="rowH"
      style="height: 5%; right: 0px; padding: 0px 0px 0px 16px;"
      v-if="this.status === 'default'"
    >
      <div class="columnH">
        <div style="color: #508944; padding-top:10%;">
          <h4>เก็บข้อมูลประชากร</h4>
        </div>
      </div>
    </div-->
    <div
    ...
    >
      <div
        class="columnH"
        style="height: 100%; width: 100%; padding: 0px 8px 0px 8px"
      >
      <div style="text-align: center; width: 100%; border-radius: 50px; backgrou-color: #F9F9F9; box-shadow: -5px -5px 5px #ffffff, 5px 5px 10px #dbdada;">
        ...
        <div>
          ...
          <div class="row" style="padding: 0px 0px 0px 16px; text-align: center;" >
            ...
            <div class="col"><div class="button button3" v-on:click="showPeople">
                  <svg
                    id="Capa_1"
             ...
             <div class="col"><div class="button button3" v-on:click="showJob">
                  <div>
                    <svg
                      id="Layer_3"
            ...
            <div class="col"><div class="button button3" v-on:click="showPlant">
                  <svg
                    id="Capa_1"
                    enable-background="new 0 0 512 512"
                    height="30"
        ...
        <div class="addData">
          <button type="button" class="btnOk" v-on:click="openFormsPage"
          >
            เพิ่มข้อมูล
          </button>
        </div>
    ...
    <!-- show form -->
    <!--div v-else>
      <div class="columnH" style="width: 80%; height: 20%; padding-left:30px; color:#ffffff;">
        <h1>กรอกข้อมูล</h1>
      </div>
      <div class="columnH" style="width: 20%; height: 20%;" >
        <button
        type="button"
    ...
    <div v-else-if="this.status === 'forms'" id="slide2">
      <div class="row">
        <div
          class="col"
          style="max-width: 70%; height: 0px; padding: 16px 0px 0px 50px;"
        >
          <h3>กรอกข้อมูล</h3>
        </div>
    ...
    <div v-else-if="this.status === 'show'" id="slide2">
      ...
      <ShowData
        :data_conclude="this.data_conclude"
        :data="this.data"
        :statusUser="this.user"
      />
    </div>
    ...
    <div v-else-if="this.status === 'showPeople'" id="slide2">
      ...
      <ShowPeople :data="this.showDataPeople" :countHome="this.countHome" :countPeople="this.countPeople" />
    </div>
...
//var houseRef = database.ref("/house");
//var peopleRef = database.ref("/people");
//var landRef = database.ref("/land");
//var incomeRef = database.ref("/income");
...
export default {
  ...
  async created() {
   ...
   /* await dataRef.on("child_added", (snapshot) => {
    ...
    this.data_peo = this.data_people;*/
    this.status_load = "default";
  },
  methods: {
    closeForms(e){
